...
public class AdapterAnime extends RecyclerView.Adapter<AdapterAnime.ViewHoder> {
    ...
    public AdapterAnime(List<VideoContect> contects) {
        this.contects = contects;
    }

    @NonNull
    @Override
    public AdapterAnime.ViewHoder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.video_item,parent,false);
        AdapterAnime.ViewHoder viewHoder = new ViewHoder(view);
        context = parent.getContext();
        return viewHoder;
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterAnime.ViewHoder holder, int position) {
